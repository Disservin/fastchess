...
[[nodiscard]] inline int minFileDescriptorRequired(int concurrency) noexcept { return 14 + concurrency * 8; }
[[nodiscard]] inline int maxConcurrency(int availableFDs) noexcept { return (availableFDs - 14) / 8; }
