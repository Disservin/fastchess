...
class GauntletScheduler : public Scheduler {
   public:
    ...
    std::size_t total() const override { return (n_seeds * n_players -  n_seeds * (n_seeds + 1) / 2) * n_rounds * n_games_per_round; }
