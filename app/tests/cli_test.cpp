...
TEST_SUITE("Option Parsing Tests") {
    TEST_CASE("Should throw tc and st not usable together") {
        ...
        CHECK_THROWS_WITH_AS(cli::cli_parse(args), "Error; cannot use tc and st together!", std::runtime_error);
    }
    ...
    TEST_CASE("Should throw no timecontrol specified") {
        ...
        CHECK_THROWS_WITH_AS(cli::cli_parse(args), "Error; no TimeControl specified!", std::runtime_error);
    }
    ...
    TEST_CASE("Should throw error too much concurrency") {
        ...
        CHECK_THROWS_WITH_AS(cli::cli_parse(args),
    ...
    TEST_CASE("Should throw too many games") {
        ...
        CHECK_THROWS_WITH_AS(cli::cli_parse(args), "Error: Exceeded -game limit! Must be less than 2",
                             std::runtime_error);
    }
    ...
    TEST_CASE("Should throw invalid sprt config") {
        ...
        CHECK_THROWS_WITH_AS(cli::cli_parse(args), "Error; SPRT: elo0 must be less than elo1!", std::runtime_error);
    }
    ...
    TEST_CASE("Should throw invalid sprt config 2") {
        ...
        CHECK_THROWS_WITH_AS(cli::cli_parse(args), "Error; SPRT: sum of alpha and beta must be less than 1!",
                             std::runtime_error);
    }
    ...
    TEST_CASE("Should throw invalid sprt config 3") {
        ...
        CHECK_THROWS_WITH_AS(cli::cli_parse(args), "Error; SPRT: invalid SPRT model!", std::runtime_error);
    }
    ...
    TEST_CASE("Should throw invalid sprt config 4") {
        ...
        CHECK_THROWS_WITH_AS(cli::cli_parse(args), "Error; SPRT: alpha must be a decimal number between 0 and 1!",
                             std::runtime_error);
    }
    ...
    TEST_CASE("Should throw invalid sprt config 5") {
        ...
        CHECK_THROWS_WITH_AS(cli::cli_parse(args), "Error; SPRT: beta must be a decimal number between 0 and 1!",
                             std::runtime_error);
    }
    ...
    TEST_CASE("Should throw no chess960 opening book") {
        ...
        CHECK_THROWS_WITH_AS(cli::cli_parse(args), "Error: Please specify a Chess960 opening book", std::runtime_error);
    }
    ...
    TEST_CASE("Should throw not enough engines") {
        ...
        CHECK_THROWS_WITH_AS(cli::cli_parse(args), "Error: Need at least two engines to start!", std::runtime_error);
    }
    ...
    TEST_CASE("Should throw no engine name") {
        ...
        CHECK_THROWS_WITH_AS(cli::cli_parse(args), "Error; please specify a name for each engine!", std::runtime_error);
    }
    ...
    TEST_CASE("Should throw engine not found") {
        ...
        CHECK_THROWS_WITH_AS(cli::cli_parse(args), "Engine not found at: ./foo.exe", std::runtime_error);
    }
