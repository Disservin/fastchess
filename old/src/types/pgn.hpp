...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(Pgn, additional_lines_rgx, event_name, site, file, notation, append_file,
                                   track_nodes, track_seldepth, track_nps, track_hashfull, track_tbhits, track_timeleft,
                                   track_latency, track_pv, min, crc)
