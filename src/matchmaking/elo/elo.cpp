...
double Elo::getError(int penta_WW, int penta_WD, int penta_WL, int penta_DD, int penta_LD,
...
double Elo::getneloError(int penta_WW, int penta_WD, int penta_WL, int penta_DD, int penta_LD,
                         int penta_LL) noexcept {
    const double pairs    = penta_WW + penta_WD + penta_WL + penta_DD + penta_LD + penta_LL;
    const double WW       = double(penta_WW) / pairs;
    const double WD       = double(penta_WD) / pairs;
...
double Elo::getDiff(int penta_WW, int penta_WD, int penta_WL, int penta_DD, int penta_LD,
                    int penta_LL) noexcept {
    const double pairs      = penta_WW + penta_WD + penta_WL + penta_DD + penta_LD + penta_LL;
    const double WW         = double(penta_WW) / pairs;
    const double WD         = double(penta_WD) / pairs;
...
double Elo::getneloDiff(int penta_WW, int penta_WD, int penta_WL, int penta_DD, int penta_LD,
                        int penta_LL) noexcept {
    const double pairs    = penta_WW + penta_WD + penta_WL + penta_DD + penta_LD + penta_LL;
    const double WW       = double(penta_WW) / pairs;
    const double WD       = double(penta_WD) / pairs;
...
std::string Elo::getLos(int penta_WW, int penta_WD, int penta_WL, int penta_DD, int penta_LD,
                        int penta_LL) noexcept {
    const double pairs    = penta_WW + penta_WD + penta_WL + penta_DD + penta_LD + penta_LL;
    const double WW       = double(penta_WW) / pairs;
    const double WD       = double(penta_WD) / pairs;
...
std::string Elo::getDrawRatio(int penta_WW, int penta_WD, int penta_WL, int penta_DD, int penta_LD,
                              int penta_LL) noexcept {
    const double pairs = penta_WW + penta_WD + penta_WL + penta_DD + penta_LD + penta_LL;
    std::stringstream ss;
...
std::string Elo::getScoreRatio(int penta_WW, int penta_WD, int penta_WL, int penta_DD, int penta_LD,
                               int penta_LL) noexcept {
    const double pairs      = penta_WW + penta_WD + penta_WL + penta_DD + penta_LD + penta_LL;
    const double WW         = double(penta_WW) / pairs;
    const double WD         = double(penta_WD) / pairs;
