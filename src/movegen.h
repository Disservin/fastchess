 ...
 *******************/
	template<Color c>
	Bitboard DoCheckmask(Board& board, Square sq)
	{
 ...
 *******************/
	template<Color c>
	Bitboard DoPinMaskRooks(Board& board, Square sq)
	{
	...
	template<Color c>
	Bitboard DoPinMaskBishops(Board& board, Square sq)
	{
		Bitboard bishop_mask =
				(board.pieces<BISHOP, ~c>() | board.pieces<QUEEN, ~c>()) & BishopAttacks(sq, board.occEnemy);
 ...
 *******************/
	template<Color c>
	Bitboard seenSquares(Board& board)
	{
...
/// @return
	...
	template<Color c>
	Bitboard LegalKingMovesCastling(const Board& board, Square sq)
	{
