...
TEST_CASE("Testing PERFT 1.1")
{
    Perft perf;
    Board b;
    b.load_fen("2kr3r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/1K1R3R b - - 3 2");
    perf.perftFunction(b, 2, 2);
...
TEST_CASE("Testing PERFT 1.2")
{
    Perft perf;
    Board b;
    b.load_fen("2kr3r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/2KR3R w - - 2 2");
    perf.perftFunction(b, 3, 3);
...
TEST_CASE("Testing PERFT 1.2")
{
    Perft perf;
    Board b;
    b.load_fen("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q2/PPPBBPpP/2KR3R w kq - 0 2");
    perf.perftFunction(b, 1, 1);
...
TEST_CASE("Testing PERFT 1.4")
{
    Perft perf;
    Board b;
    b.load_fen("r3k2r/p1ppqpb1/Bn2pnp1/3PN3/1p2P3/2N2Q2/PPPB1PpP/2KR3R b kq - 0 2");
    perf.perftFunction(b, 2, 2);
...
TEST_CASE("Testing PERFT 1.5")
{
    Perft perf;
    Board b;
    b.load_fen("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/2KR3R b kq - 1 1");
    perf.perftFunction(b, 4, 4);
...
TEST_CASE("Testing PERFT 3")
{
    ...
    Perft perf;
    Board b;
    b.load_fen("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 1");
...
TEST_CASE("Testing PERFT 4")
{
    ...
    Perft perf;
    Board b;
    b.load_fen("r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1");
...
TEST_CASE("Testing PERFT 6")
{
    ...
    Perft perf;
    Board b;
    b.load_fen("r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10");
...
TEST_CASE("Testing PERFT 7")
{
    ...
    Perft perf;
    Board b;
    b.load_fen("4r3/bpk5/5n2/2P1P3/8/4K3/8/8 w - - 0 1");
...
TEST_CASE("Testing PERFT 8")
{
    ...
    Perft perf;
    Board b;
    b.load_fen("b2r4/2q3k1/p5p1/P1r1pp2/R1pnP2p/4NP1P/1PP2RPK/Q4B2 w - - 2 29");
...
TEST_CASE("Testing PERFT 9")
{
    ...
    Perft perf;
    Board b;
    b.load_fen("3n1k2/8/4P3/8/8/8/8/2K1R3 w - - 0 1");
